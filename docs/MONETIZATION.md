# Monetization — Berlin Culture App

> **Part of a 3-doc strategy set** (split from the original combined report):
>
> | Doc | Covers | Sections |
> | --- | --- | --- |
> | **MONETIZATION.md** (this) | earning models, affiliate reality, partnerships | §0–§7, §10–§16 |
...
> "§9" or "§17" may live in a sibling doc (use the map above). All program facts verified
> June 2026; code is **not** implemented unless marked ✅.
...
12. [What "affiliate program" means](#12-what-affiliate-program-means-plain-language)
13. [The `promotedBoost` hook](#13-the-promotedboost-monetization-hook)
14. [Niche-content disadvantage & how to overcome it](#14-the-niche-content-disadvantage--how-to-overcome-it)
15. [How we choose: realism vs strategic fit](#15-how-we-choose-realism-vs-strategic-fit)
16. [Roadmap: direct venue/promoter partnerships](#16-roadmap-direct-venuepromoter-partnerships-powered-by-our-scraping)
...
|---|---|---|---|---|---|
| **0** | Log outbound clicks **by domain** | ~1 hr | €0 (measurement) | No | ✅ Done (domain + venue captured) |
...
1. **Phase 0 — instrument outbound clicks by domain** (free, ~1 hr). Measure. ✅ Done.
2. **GEO quick win** — AI-crawler `robots.txt` + Event JSON-LD schema (free, ~1 hr). Plays to freshness. ✅ Done (see LAUNCH_AND_LEGAL §17-B).
...
> **(1) get the app live & marketed** (distribution + GEO — see DISTRIBUTION §8/§9 and
> LAUNCH_AND_LEGAL §17) →
